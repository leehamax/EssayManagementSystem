...
<div class="lefter">
    <div class="logo">
        <a href="http://www.pintuer.com" target="_blank"></a>
    </div>
</div>
...
<div class="admin">
    ...
    <%
        ...
        ArrayList OthersNews = newsRealeseDao.UserQueryOthersNews(username);
    %>


    <div class="panel admin-panel">
        <div class="panel-head"><strong>我可见文章列表</strong></div>
        <table class="table table-hover">
            <tr>
                <th width="45">选择</th>
                <th width="300">标题</th>
            ...
            <%
                for (int i = 0; i < OthersNews.size(); i++) {
                    NewsRealese tem = (NewsRealese) OthersNews.get(i);
            %>
            <tr>
                <td>
                    <input type="checkbox" name="id" value="<%=i%>>"/>
                ...
                <td>
                    <a class="button border-green button-little" href="#"
                       onclick="queryInfo('<%=tem.getNewsId()%>','news')">查看详情</a>
                </td>
            </tr>
            <%
                }
                ...
                <div class="tab-body">
                    ...
                    <div class="tab-panel active" id="tab-set">
                            ...
                            <div class="form-button" align="center">
                                <button class="button bg-main" onclick="updateNews('${username}','news')">提交修改</button>
                            </div>
